package com.danheskett.openjack;
 ...
 */
public class OpenjackActivity extends NativeActivity {

    // NativeActivity loads libopenjack.so by dlopen()ing it in framework
