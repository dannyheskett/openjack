...
keytool -genkeypair -v \
  -keystore openjack-upload.jks \
  -alias openjack-upload \
  -keyalg RSA -keysize 2048 -validity 10000 \
  -dname "CN=Danny Heskett, O=openjack, C=US"
```

It prompts for a **keystore password** and a **key password** — pick strong
ones and save them in your password manager. Keep `openjack-upload.jks`
...
```sh
base64 -w0 openjack-upload.jks > upload.jks.b64
gh secret set PLAY_UPLOAD_KEYSTORE   < upload.jks.b64
gh secret set PLAY_KEY_ALIAS         -b "openjack-upload"
...
secret and produce `openjack-<version>-android.aab` alongside the sideload
