#ifndef OPENJACK_PLAT_IOS_H
#define OPENJACK_PLAT_IOS_H

#include "oj_types.h" // Vector2, bool

// State pushed from the UIKit view (ios_main.mm) into the C-facing queries the
// game reads through oj_types.h (GetScreenWidth / GetTouchPosition / …). All
