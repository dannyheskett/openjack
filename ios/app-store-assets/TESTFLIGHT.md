# Getting openjack into TestFlight
...
Throughout: bundle ID is `com.danheskett.openjack`, and it must match
...
per-app and must be done for openjack.
...
- Type: **App IDs** → **App**
- Description: `openjack`
- Bundle ID: **Explicit** → `com.danheskett.openjack`
...
- App ID: `com.danheskett.openjack`
...
| --- | --- |
| Platform | iOS |
| Name | `openjack` (see [LISTING.md](LISTING.md) for fallbacks if taken) |
